  ...
  <div class="container mx-auto px-4 sm:px-8 xl:px-10 2xl:px-40 mb-12 h-full">
    ...
    <div v-else-if="booking">
        ...
        <div class="absolute inset-x-4 bottom-4">
          ...
          >
            <div class="w-full">
              ...
              <p>
                <span class="font-bold">{{ t('booked_by') }}:</span>
                {{ booking.user?.email }}
              </p>
              <p class="text-lg mt-2">
                <span class="font-bold">{{ t('total_price_paid') }}:</span> €{{
                  booking.totalPrice
                }}
              </p>
            </div>
      ...
      <div class="flex gap-6">
          ...
          <div>
            <ul class="space-y-4">
              ...
              >
                <div class="flex gap-2 items-center">
                  <div>
                    <h3 class="font-bold">{{ t('end_of_trip') }}</h3>
                    <p class="text-sm text-gray-500">{{ t('return_home') }}</p>
                  </div>
                </div>
              </li>
            </ul>
        ...
        <!-- Map and Editing View on Right Side -->
        <div
...
const toggleBigMap = () => {
  ...
  //console.log('bigMapView', bigMap.value )
  if (isMapView.value) {
...
watch(result, value => {
  if (value) {
    ...
    console.log
    if (
      value?.booking?.bookableTrip?.status === 'FINISHED' ||
      value?.booking?.bookableTrip?.status === 'CANCELLED'
    ) {
      router.push('/oldbookings/' + bookingToFind)
    }
